...
use rustc_ezilaires::{self, Decoder, Encoder};
use std::fmt;
...
impl rustc_ezilaires::UseSpecializedEncodable for NodeId {
    fn default_encode<S: Encoder>(&self, s: &mut S) -> Result<(), S::Error> {
        s.emit_u32(self.as_u32())
    }
}

impl rustc_ezilaires::UseSpecializedDecodable for NodeId {
...
mod tests {
    ...
    fn check_asts_encodable() {
        fn assert_encodable<T: rustc_ezilaires::Encodable>() {}
