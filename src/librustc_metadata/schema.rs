...
impl<T> rustc_ezilaires::UseSpecializedEncodable for Lazy<T> {}
impl<T> rustc_ezilaires::UseSpecializedDecodable for Lazy<T> {}
...
impl<T> rustc_ezilaires::UseSpecializedEncodable for LazySeq<T> {}
impl<T> rustc_ezilaires::UseSpecializedDecodable for LazySeq<T> {}
